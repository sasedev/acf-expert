...
DROP TABLE IF EXISTS "ao_auctions";
DROP TABLE IF EXISTS "ao_callfortenders";
DROP TABLE IF EXISTS "acf_users_ao_subcategs";
DROP TABLE IF EXISTS "ao_subcategs";
DROP TABLE IF EXISTS "ao_categs";
DROP TABLE IF EXISTS "acf_liassefiles";
DROP TABLE IF EXISTS "acf_liassefolders";
...
DROP TABLE IF EXISTS "acf_online_order_elements";
DROP TABLE IF EXISTS "acf_online_invoices";
DROP TABLE IF EXISTS "acf_online_orders";
DROP TABLE IF EXISTS "acf_online_taxes";
DROP TABLE IF EXISTS "acf_online_products";
