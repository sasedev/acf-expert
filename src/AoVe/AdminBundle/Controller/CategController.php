...
use AoVe\AdminBundle\Form\AoCateg\NewTForm as AoCategNewTForm;
use AoVe\AdminBundle\Form\AoCateg\UpdateTitleTForm as AoCategUpdateTitleTForm;
use AoVe\AdminBundle\Form\AoCateg\UpdatePriorityTForm as AoCategUpdatePriorityTForm;
use AoVe\AdminBundle\Form\AoSubCateg\NewTForm as AoSubCategNewTForm;
...
class CategController extends BaseController
{
    ...
    public function listAction()
    {
        ...
        return $this->renderResponse('AoVeAdminBundle:AoCateg:list.html.twig', $this->gvars);
    }
    ...
    public function addGetAction()
    {
        if (!$this->hasRole('ROLE_SUPERADMIN')) {
            return $this->redirect($this->generateUrl('aove_admin_categ_list'));
        }
        $categ = new AoCateg();
        ...
        return $this->renderResponse('AoVeAdminBundle:AoCateg:add.html.twig', $this->gvars);
    }
    ...
    public function addPostAction()
    {
        ...
        if (null == $urlFrom || trim($urlFrom) == '') {
            return $this->redirect($this->generateUrl('aove_admin_categ_addGet'));
        }
        ...
        if (isset($reqData['AoCategNewForm'])) {
            ...
            if ($categNewForm->isValid()) {
                ...
                return $this->redirect($this->generateUrl('aove_admin_categ_editGet', array(
                    'uid' => $categ->getId()
                )));
            } else {
    ...
    public function editGetAction($uid)
    {
        ...
        try {
            ...
            if (null == $categ) {
                ...
                return $this->renderResponse('AoVeAdminBundle:AoCateg:edit.html.twig', $this->gvars);
            }
        } catch (\Exception $e) {
            $logger = $this->getLogger();
            $logger->addCritical($e->getLine() . ' ' . $e->getMessage() . ' ' . $e->getTraceAsString());
