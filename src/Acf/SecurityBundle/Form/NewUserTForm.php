...
class NewUserTForm extends AbstractType
{
	...
	public function buildForm(FormBuilderInterface $builder, array $options)
	{
		...
		$builder->add('preferedLang', EntityType::class,
			array('label' => 'User.preferedLang.label', 'class' => 'AcfDataBundle:Lang',
				'query_builder' => function (LangRepository $lr)
				{
					return $lr->createQueryBuilder('l')
						->orderBy('l.locale', 'ASC');
				}, 'choice_label' => 'fullLocale', 'multiple' => false, 'by_reference' => true, 'required' => false,
				'placeholder' => 'Options.choose', 'empty_data' => null));

		$builder->add('sexe', ChoiceType::class,
			array('label' => 'User.sexe.label', 'choices_as_values' => true, 'choices' => User::choiceSexe(),
				'attr' => array('choice_label_trans' => true)));

		$builder->add('firstName', TextType::class, array('label' => 'User.firstName.label'));

		$builder->add('lastName', TextType::class, array('label' => 'User.lastName.label'));

		$builder->add('birthday', DateType::class,
			array('label' => 'User.birthday.label', 'widget' => 'single_text', 'format' => 'yyyy-MM-dd', 'required' => false));
		...
		$builder->add('country', CountryType::class,
			array('label' => 'User.country.label', 'required' => false, 'placeholder' => 'Options.choose', 'empty_data' => null));
	...
	{
		return array('validation_groups' => array('username', 'email', 'sexe', 'birthday', 'streetNum', 'town', 'zipCode', 'country', 'phone', 'mobile'));
	}
