...
class EventAddAdminTForm extends AbstractType
{
	...
	public function buildForm(FormBuilderInterface $builder, array $options)
	{
		...
		$builder->add('comment', TextareaType::class, array('label' => 'Agenda.comment.label'));
		...
		$builder->add('users', EntityType::class,
			array('label' => 'Agenda.users.label', 'class' => 'AcfDataBundle:User',
				'query_builder' => function (UserRepository $ur)
				{
					return $ur->createQueryBuilder('u')
						->orderBy('u.username', 'ASC');
				}, 'choice_label' => 'fullName', 'multiple' => true, 'by_reference' => true, 'required' => false));
	}
	...
	{
		return array('validation_groups' => array('title', 'comment', 'users'), 'csrf_protection' => false);
	}
