...
class NewTForm extends AbstractType
{
	...
	{
		$builder->add('name', TextType::class, array('label' => 'ConstantStr.name.label'));

		$builder->add('value', TextType::class, array('label' => 'ConstantStr.value.label'));
