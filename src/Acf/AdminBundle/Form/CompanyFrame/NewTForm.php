...
class NewTForm extends AbstractType
{
	...
	public function buildForm(FormBuilderInterface $builder, array $options)
	{
		...
		if (null == $this->company) {
			$builder->add('company', EntityType::class,
				array('label' => 'CompanyFrame.company.label', 'class' => 'AcfDataBundle:Company',
		...
		if (null == $this->job) {
			$builder->add('job', EntityType::class,
				array('label' => 'CompanyFrame.job.label', 'class' => 'AcfDataBundle:Job',
			...
			$builder->add('job', EntityidType::class,
				array('label' => 'CompanyFrame.job.label', 'class' => 'AcfDataBundle:Job',
					'query_builder' => function (JobRepository $br) use ($job_id)
					{
						return $br->createQueryBuilder('j')
							->where('j.id = :id')
		...
		$builder->add('sexe', ChoiceType::class,
			array('label' => 'CompanyFrame.sexe.label', 'choices_as_values' => true, 'choices' => CompanyFrame::choiceSexe(),
		...
		$builder->add('country', CountryType::class,
			array('label' => 'CompanyFrame.country.label', 'required' => false, 'placeholder' => 'Options.choose', 'empty_data' => null));
	...
	{
		return array('validation_groups' => array('sexe', 'phone', 'email', 'mobile'), 'company' => null, 'job' => null);
	}
