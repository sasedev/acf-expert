...
namespace Acf\AdminBundle\Form\Fund;
...
class NewTForm extends AbstractType
{
	...
	public function buildForm(FormBuilderInterface $builder, array $options)
	{
		...
		if (null == $this->company) {
			$builder->add('company', EntityType::class,
				array('label' => 'Fund.company.label', 'class' => 'AcfDataBundle:Company',
		...
		$builder->add('label', TextType::class, array('label' => 'Fund.label.label'));

		$builder->add('number', IntegerType::class, array('label' => 'Fund.number.label'));

		$builder->add('otherInfos', TextareaType::class, array('label' => 'Fund.otherInfos.label', 'required' => false));
	}
	...
	{
		return array('validation_groups' => array('label', 'number'), 'company' => null);
	}
