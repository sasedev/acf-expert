	...
	public function buildForm(FormBuilderInterface $builder, array $options)
	{
		...
		if (null == $this->company) {
			$builder->add('company', EntityType::class,
				array('label' => 'Docgroupsyst.company.label', 'class' => 'AcfDataBundle:Company',
			...
			$builder->add('parent', EntityType::class,
				array('label' => 'Docgroupsyst.parent.label', 'class' => 'AcfDataBundle:Docgroupsyst',
			...
			$builder->add('clone', EntityType::class,
				array('label' => 'Docgroup.clone.label', 'class' => 'AcfDataBundle:Docgroupsyst',
					'query_builder' => function (DocgroupsystRepository $dgr)
					{
						return $dgr->createQueryBuilder('d')
							->orderBy('d.pageUrlFull', 'ASC');
			...
			$builder->add('parent', EntityType::class,
				array('label' => 'Docgroupsyst.parent.label', 'class' => 'AcfDataBundle:Docgroupsyst',
					'query_builder' => function (DocgroupsystRepository $dgr) use ($company_id)
					{
						return $dgr->createQueryBuilder('d')
							->join('d.company', 'c')
							->where('c.id = :id')
		...
		$builder->add('label', TextType::class, array('label' => 'Docgroupsyst.label.label'));

		$builder->add('otherInfos', TextareaType::class, array('label' => 'Docgroupsyst.otherInfos.label', 'required' => false));
	}
