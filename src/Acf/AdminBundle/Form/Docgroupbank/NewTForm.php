    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        if (null == $this->company) {
            $builder->add('company', EntityType::class, array(
                'label' => 'Docgroupbank.company.label',
            ...
            $builder->add('parent', EntityType::class, array(
                'label' => 'Docgroupbank.parent.label',
                'class' => 'AcfDataBundle:Docgroupbank',
                'query_builder' => function (DocgroupbankRepository $dgr) use ($companyId) {
        ...
        $builder->add('label', TextType::class, array(
            'label' => 'Docgroupbank.label.label'
        ));

        $builder->add('otherInfos', TextareaType::class, array(
            'label' => 'Docgroupbank.otherInfos.label',
            'required' => false
        ));
    }
