	...
	public function buildForm(FormBuilderInterface $builder, array $options)
	{
		...
		if (null == $this->company) {
			$builder->add('company', EntityType::class,
				array('label' => 'Docgroupbank.company.label', 'class' => 'AcfDataBundle:Company',
			...
			$builder->add('parent', EntityType::class,
				array('label' => 'Docgroupbank.parent.label', 'class' => 'AcfDataBundle:Docgroupbank',
					'query_builder' => function (DocgroupbankRepository $dgr)
					{
			...
			$builder->add('clone', EntityType::class,
				array('label' => 'Docgroup.clone.label', 'class' => 'AcfDataBundle:Docgroupbank',
					'query_builder' => function (DocgroupbankRepository $dgr)
					{
						return $dgr->createQueryBuilder('d')
							->orderBy('d.pageUrlFull', 'ASC');
			...
			$builder->add('parent', EntityType::class,
				array('label' => 'Docgroupbank.parent.label', 'class' => 'AcfDataBundle:Docgroupbank',
					'query_builder' => function (DocgroupbankRepository $dgr) use ($company_id)
					{
						return $dgr->createQueryBuilder('d')
							->join('d.company', 'c')
							->where('c.id = :id')
		...
		$builder->add('label', TextType::class, array('label' => 'Docgroupbank.label.label'));

		$builder->add('otherInfos', TextareaType::class, array('label' => 'Docgroupbank.otherInfos.label', 'required' => false));
	}
