	...
	public function buildForm(FormBuilderInterface $builder, array $options)
	{
		...
		if (null == $this->company) {
			$builder->add('company', EntityType::class,
				array('label' => 'Docgroup.company.label', 'class' => 'AcfDataBundle:Company',
			...
			$builder->add('parent', EntityType::class,
				array('label' => 'Docgroup.parent.label', 'class' => 'AcfDataBundle:Docgroup',
			...
			$builder->add('clone', EntityType::class,
				array('label' => 'Docgroup.clone.label', 'class' => 'AcfDataBundle:Docgroup',
					'query_builder' => function (DocgroupRepository $dgr)
					{
						return $dgr->createQueryBuilder('d')
							->orderBy('d.pageUrlFull', 'ASC');
			...
			$builder->add('parent', EntityType::class,
				array('label' => 'Docgroup.parent.label', 'class' => 'AcfDataBundle:Docgroup',
					'query_builder' => function (DocgroupRepository $dgr) use ($company_id)
					{
						return $dgr->createQueryBuilder('d')
							->join('d.company', 'c')
							->where('c.id = :id')
		...
		$builder->add('label', TextType::class, array('label' => 'Docgroup.label.label'));

		$builder->add('otherInfos', TextareaType::class, array('label' => 'Docgroup.otherInfos.label', 'required' => false));
	}
