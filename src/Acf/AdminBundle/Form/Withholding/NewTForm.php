...
class NewTForm extends AbstractType
{
	...
	public function buildForm(FormBuilderInterface $builder, array $options)
	{
		...
		if (null == $this->company) {
			$builder->add('company', EntityType::class,
				array('label' => 'Withholding.company.label', 'class' => 'AcfDataBundle:Company',
		...
		$builder->add('label', TextType::class, array('label' => 'Withholding.label.label'));

		$builder->add('number', IntegerType::class, array('label' => 'Withholding.number.label'));

		$builder->add('value', NumberType::class, array('label' => 'Withholding.value.label'));

		$builder->add('otherInfos', TextareaType::class, array('label' => 'Withholding.otherInfos.label', 'required' => false));
	}
	...
	{
		return array('validation_groups' => array('label', 'number', 'value'), 'company' => null);
	}
