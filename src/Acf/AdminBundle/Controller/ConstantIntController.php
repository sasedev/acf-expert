    ...
    public function addPostAction()
    {
        ...
        if (isset($reqData['ConstantIntNewForm'])) {
            ...
            if ($constantIntNewForm->isValid()) {
                ...
                $em->flush();
                $this->flashMsgSession('success', $this->translate('ConstantInt.add.success', array(
                    '%constantInt%' => $constantInt->getName()
                )));

                return $this->redirect($this->generateUrl('_admin_constantInt_editGet', array(
                    'uid' => $constantInt->getId()
                )));
            } else {
                $this->flashMsgSession('error', $this->translate('ConstantInt.add.failure'));
            }
        }
        $this->gvars['ConstantIntNewForm'] = $constantIntNewForm->createView();
    ...
    public function deleteAction($uid)
    {
        ...
        try {
            ...
            if (null == $constantInt) {
                ...
                $this->flashMsgSession('success', $this->translate('ConstantInt.delete.success', array(
                    '%constantInt%' => $constantInt->getName()
                )));
            }
        } catch (\Exception $e) {
    ...
    public function editGetAction($uid)
    {
        ...
        try {
            ...
            if (null == $constantInt) {
                ...
                $this->gvars['pagetitle'] = $this->translate('pagetitle.constantInt.edit', array(
                    '%constantInt%' => $constantInt->getName()
                ));
                $this->gvars['pagetitle_txt'] = $this->translate('pagetitle.constantInt.edit.txt', array(
                    '%constantInt%' => $constantInt->getName()
                ));
            ...
            if (null == $constantInt) {
                ...
                if (isset($reqData['ConstantIntUpdateDescriptionForm'])) {
                    ...
                    if ($constantIntUpdateDescriptionForm->isValid()) {
                        $em->persist($constantInt);
                        $em->flush();
                        $this->flashMsgSession('success', $this->translate('ConstantInt.edit.success', array(
                            '%constantInt%' => $constantInt->getName()
                        )));
                        ...
                        $this->flashMsgSession('error', $this->translate('ConstantInt.edit.failure', array(
                            '%constantInt%' => $constantInt->getName()
                        )));
                    }
