...
class WithholdingController extends BaseController
{
    ...
    public function deleteAction($uid)
    {
        ...
        try {
            ...
            if (null == $withholding) {
                ...
                $this->flashMsgSession('success', $this->translate('Withholding.delete.success', array(
    ...
    public function editGetAction($uid)
    {
        ...
        try {
            ...
            if (null == $withholding) {
                ...
                $this->gvars['pagetitle'] = $this->translate('pagetitle.withholding.edit', array(
                    '%withholding%' => $withholding->getLabel()
                ));
                $this->gvars['pagetitle_txt'] = $this->translate('pagetitle.withholding.edit.txt', array(
                    '%withholding%' => $withholding->getLabel()
                ));
            ...
            if (null == $withholding) {
                ...
                if (isset($reqData['WithholdingUpdateLabelForm'])) {
                    ...
                    if ($withholdingUpdateLabelForm->isValid()) {
                        ...
                        $em->flush();
                        $this->flashMsgSession('success', $this->translate('Withholding.edit.success', array(
                            '%withholding%' => $withholding->getLabel()
                        )));
                        ...
                        $this->flashMsgSession('error', $this->translate('Withholding.edit.failure', array(
                            '%withholding%' => $withholding->getLabel()
                        )));
                    }
    ...
    protected function traceEntity(Withholding $cloneWithholding, Withholding $withholding)
    {
        ...
        if ($msg != '') {
            ...
            $trace->setMsg($this->translate('Withholding.traceEdit', array(
                '%withholding%' => $withholding->getLabel(),
                '%company%' => $withholding->getCompany()
                    ->getCorporateName()
            )) . $msg);
