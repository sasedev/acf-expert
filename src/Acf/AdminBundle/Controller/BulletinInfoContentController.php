		...
		try {
			...
			if (null == $bulletinInfoContent) {
				...
				$this->flashMsgSession('success',
					$this->translate('BulletinInfoContent.delete.success', array('%bulletinInfoContent%' => $bulletinInfoContent->getTitle())));
			}
		} catch (\Exception $e) {
	...
	public function editGetAction($uid)
	{
		...
		try {
			...
			if (null == $bulletinInfoContent) {
				...
				$this->gvars['pagetitle'] = $this->translate('pagetitle.bulletinInfoContent.edit',
					array('%bulletinInfoContent%' => $bulletinInfoContent->getTitle()));
				$this->gvars['pagetitle_txt'] = $this->translate('pagetitle.bulletinInfoContent.edit.txt',
					array('%bulletinInfoContent%' => $bulletinInfoContent->getTitle()));
			...
			if (null == $bulletinInfoContent) {
				...
				if (isset($reqData['BulletinInfoContentUpdateTitleForm'])) {
					...
					if ($bulletinInfoContentUpdateTitleForm->isValid()) {
						...
						$em->flush();
						$this->flashMsgSession('success',
							$this->translate('BulletinInfoContent.edit.success', array('%bulletinInfoContent%' => $bulletinInfoContent->getTitle())));
						...
						$this->flashMsgSession('error',
							$this->translate('BulletinInfoContent.edit.failure', array('%bulletinInfoContent%' => $bulletinInfoContent->getTitle())));
					}
