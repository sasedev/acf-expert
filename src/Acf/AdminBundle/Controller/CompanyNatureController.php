...
class CompanyNatureController extends BaseController
{
    ...
    public function deleteAction($uid)
    {
        ...
        try {
            ...
            if (null == $companyNature) {
                ...
                $this->flashMsgSession('success', $this->translate('CompanyNature.delete.success', array(
    ...
    public function editGetAction($uid)
    {
        ...
        try {
            ...
            if (null == $companyNature) {
                ...
                $this->gvars['pagetitle'] = $this->translate('pagetitle.companyNature.edit', array(
                    '%companyNature%' => $companyNature->getLabel()
                ));
                $this->gvars['pagetitle_txt'] = $this->translate('pagetitle.companyNature.edit.txt', array(
                    '%companyNature%' => $companyNature->getLabel()
                ));
            ...
            if (null == $companyNature) {
                ...
                if (isset($reqData['CompanyNatureUpdateForm'])) {
                    ...
                    if ($companyNatureUpdateForm->isValid()) {
                        ...
                        $em->flush();
                        $this->flashMsgSession('success', $this->translate('CompanyNature.edit.success', array(
                            '%companyNature%' => $companyNature->getLabel()
                        )));
                        ...
                        $this->flashMsgSession('error', $this->translate('CompanyNature.edit.failure', array(
                            '%companyNature%' => $companyNature->getLabel()
                        )));
                    }
                }
    ...
    protected function traceEntity(CompanyNature $cloneCompanyNature, CompanyNature $companyNature)
    {
        ...
        if ($msg != '') {
            ...
            $trace->setMsg($this->translate('CompanyNature.traceEdit', array(
                '%companyNature%' => $companyNature->getLabel(),
                '%company%' => $companyNature->getCompany()
                    ->getCorporateName()
            )) . $msg);
