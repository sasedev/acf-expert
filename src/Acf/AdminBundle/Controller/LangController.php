    ...
    public function addPostAction()
    {
        ...
        if (isset($reqData['LangNewForm'])) {
            ...
            if ($langNewForm->isValid()) {
                ...
                $em->persist($lang);
                $em->flush();
                $this->flashMsgSession('success', $this->translate('Lang.add.success', array(
                    '%lang%' => $lang->getLocale()
                )));

                return $this->redirect($this->generateUrl('_admin_lang_editGet', array(
                    'id' => $lang->getId()
                )));
            } else {
                $this->flashMsgSession('error', $this->translate('Lang.add.failure'));
            }
        }
        $this->gvars['LangNewForm'] = $langNewForm->createView();
    ...
    public function deleteAction($id)
    {
        ...
        try {
            ...
            if (null == $lang) {
                ...
                $this->flashMsgSession('success', $this->translate('Lang.delete.success', array(
                    '%lang%' => $lang->getLocale()
                )));
            }
        } catch (\Exception $e) {
    ...
    public function editGetAction($id)
    {
        ...
        try {
            ...
            if (null == $lang) {
                ...
                $this->gvars['pagetitle'] = $this->translate('pagetitle.lang.edit', array(
                    '%lang%' => $lang->getLocale()
                ));
                $this->gvars['pagetitle_txt'] = $this->translate('pagetitle.lang.edit.txt', array(
                    '%lang%' => $lang->getLocale()
                ));
            ...
            if (null == $lang) {
                ...
                if (isset($reqData['LangUpdateDirectionForm'])) {
                    ...
                    if ($langUpdateDirectionForm->isValid()) {
                        $em->persist($lang);
                        $em->flush();
                        $this->flashMsgSession('success', $this->translate('Lang.edit.success', array(
                            '%lang%' => $lang->getLocale()
                        )));
                        ...
                        $this->flashMsgSession('error', $this->translate('Lang.edit.failure', array(
                            '%lang%' => $lang->getLocale()
                        )));
                    }
