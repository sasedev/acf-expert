...
class UpdatePaymentTypeTForm extends AbstractType
{
	...
	public function buildForm(FormBuilderInterface $builder, array $options)
	{
		$builder->add('paymentType', ChoiceType::class,
			array('label' => 'Sale.paymentType.label', 'choices_as_values' => true, 'choices' => Sale::choicePaymentType(),
	...
	{
		return 'SaleUpdatePaymentTypeForm';
	}
	...
	{
		return array('validation_groups' => array('paymentType'));
	}
