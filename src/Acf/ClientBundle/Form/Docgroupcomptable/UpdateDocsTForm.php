...
namespace Acf\ClientBundle\Form\Docgroupcomptable;
...
class UpdateDocsTForm extends AbstractType
{
	...
	public function buildForm(FormBuilderInterface $builder, array $options)
	{
		...
		if (null == $this->company) {
			$builder->add('docs', EntityType::class,
				array('label' => 'Docgroupcomptable.docs.label', 'class' => 'AcfDataBundle:Doc',
	...
	{
		return 'DocgroupcomptableUpdateDocsForm';
	}
