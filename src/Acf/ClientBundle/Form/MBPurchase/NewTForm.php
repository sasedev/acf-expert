...
namespace Acf\ClientBundle\Form\MBPurchase;
...
class NewTForm extends AbstractType
{
	...
	public function buildForm(FormBuilderInterface $builder, array $options)
	{
		...
		$builder->add('month', ChoiceType::class,
			array('label' => 'MBPurchase.month.label', 'choices_as_values' => true, 'choices' => MBPurchase::choiceMonth(),
				'attr' => array('choice_label_trans' => true)));

		$builder->add('year', IntegerType::class, array('label' => 'MBPurchase.year.label'));
	}
	...
	{
		return array('validation_groups' => array('month', 'year'), 'company' => null);
	}
