		...
		try {
			...
			if (null == $secondaryVat) {
				...
				$this->flashMsgSession(
					'success',
					$this->translate('SecondaryVat.delete.success', array('%sale%' => $secondaryVat->getSale()->getNumber(), '%secondaryVat%' => $this->translate('SecondaryVat.vatInfo.'.$secondaryVat->getVatInfo()) ))
				);
			}
		} catch (\Exception $e) {
			...
			if (null == $secondaryVat) {
				...
				if (isset($reqData['SecondaryVatUpdateVatInfoForm'])) {
					...
					if ($secondaryVatUpdateVatInfoForm->isValid()) {
						...
						$this->flashMsgSession(
							'success',
							$this->translate('SecondaryVat.edit.success', array('%sale%' => $secondaryVat->getSale()->getNumber(), '%secondaryVat%' => $this->translate('SecondaryVat.vatInfo.'.$secondaryVat->getVatInfo())))
						);
