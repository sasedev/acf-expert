...
class TraceListener implements EventSubscriber
{
	...
	{
		return array('postPersist', 'postRemove');
	}
	...
	public function postPersist(LifecycleEventArgs $args)
	{
		...
		if ($entity instanceof User) {
			...
			$trace->setMsg($trans->trans('User.traceNew', array('%user%' => $entity->getFullName())));
			$this->persist($trace, $em);
		} elseif ($entity instanceof Job) {
			$trace->setActionEntity(Trace::AE_JOB);
			$trace->setMsg($trans->trans('Job.traceNew', array('%job%' => $entity->getLabel())));
			$this->persist($trace, $em);
		} elseif ($entity instanceof CompanyType) {
			$trace->setActionEntity(Trace::AE_TYPE);
			$trace->setMsg($trans->trans('CompanyType.traceNew', array('%companyType%' => $entity->getLabel())));
			$this->persist($trace, $em);
		} elseif ($entity instanceof Sector) {
			$trace->setActionEntity(Trace::AE_SECTOR);
			$trace->setMsg($trans->trans('Sector.traceNew', array('%sector%' => $entity->getLabel())));
			$this->persist($trace, $em);
			...
			$trace->setMsg(
				$trans->trans('Address.traceNew',
					array('%address%' => $entity->getFullAddress(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			...
			$trace->setMsg(
				$trans->trans('Phone.traceNew',
					array('%phone%' => $entity->getPhone(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			$trace->setActionEntity2(Trace::AE_COMPANY);
			...
			$trace->setMsg(
				$trans->trans('CompanyFrame.traceNew',
					array('%companyFrame%' => $entity->getFullName(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			$trace->setActionEntity2(Trace::AE_COMPANY);
			...
			$trace->setMsg(
				$trans->trans('CompanyNature.traceNew',
					array('%companyNature%' => $entity->getLabel(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			$trace->setActionEntity2(Trace::AE_COMPANY);
			...
			$trace->setMsg(
				$trans->trans('CompanyLabel.traceNew',
					array('%companyLabel%' => $entity->getName(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			$trace->setActionEntity2(Trace::AE_COMPANY);
			...
			$trace->setMsg(
				$trans->trans('Customer.traceNew',
					array('%customer%' => $entity->getLabel(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			$trace->setActionEntity2(Trace::AE_COMPANY);
			...
			$trace->setMsg(
				$trans->trans('Supplier.traceNew',
					array('%supplier%' => $entity->getLabel(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			$trace->setActionEntity2(Trace::AE_COMPANY);
			...
			$trace->setMsg(
				$trans->trans('Bank.traceNew',
					array('%bank%' => $entity->getLabel(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			$trace->setActionEntity2(Trace::AE_COMPANY);
			...
			$trace->setMsg(
				$trans->trans('Fund.traceNew',
					array('%fund%' => $entity->getLabel(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			$trace->setActionEntity2(Trace::AE_COMPANY);
			...
			$trace->setMsg(
				$trans->trans('Withholding.traceNew',
					array('%withholding%' => $entity->getLabel(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			$trace->setActionEntity2(Trace::AE_COMPANY);
			...
			$trace->setMsg(
				$trans->trans('MBSale.traceNew',
					array('%mbsale%' => $entity->getRef(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			$trace->setActionEntity2(Trace::AE_COMPANY);
			...
			$trace->setMsg(
				$trans->trans('MBPurchase.traceNew',
					array('%mbpurchase%' => $entity->getRef(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			$trace->setActionEntity2(Trace::AE_COMPANY);
			...
			$trace->setMsg(
				$trans->trans('Sale.traceNew',
					array('%sale%' => $entity->getLabel(), '%mbsale%' => $entity->getMonthlyBalance()
						->getRef(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			$trace->setActionEntity2(Trace::AE_COMPANY);
			...
			$trace->setMsg(
				$trans->trans('Buy.traceNew',
					array('%buy%' => $entity->getLabel(), '%mbpurchase%' => $entity->getMonthlyBalance()
						->getRef(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			...
			$trace->setMsg(
				$trans->trans('SecondaryVat.traceNew',
					array('%secondaryVat%' => $trans->trans('SecondaryVat.vatInfo.' . $entity->getVatInfo()),
						'%sale%' => $entity->getSale()
							->getLabel(), '%mbsale%' => $entity->getSale()
							->getMonthlyBalance()
							->getRef(), '%company%' => $entity->getSale()
							->getMonthlyBalance()
							->getCompany()
							->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
			...
			$trace->setMsg(
				$trans->trans('Shareholder.traceNew',
					array('%shareholder%' => $entity->getName(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			$trace->setActionEntity2(Trace::AE_COMPANY);
			...
			$trace->setMsg(
				$trans->trans('Pilot.traceNew',
					array('%pilot%' => $entity->getRef(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			$trace->setActionEntity2(Trace::AE_COMPANY);
			...
			$trace->setMsg(
				$trans->trans('CompanyUser.traceNew',
					array('%user%' => $entity->getUser()
						->getFullName(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			$trace->setActionEntity2(Trace::AE_COMPANY);
			...
			$trace->setMsg(
				$trans->trans('CompanyAdmin.traceNew',
					array('%user%' => $entity->getUser()
						->getFullName(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
			...
			$trace->setMsg(
				$trans->trans('Doc.traceNew',
					array('%doc%' => $entity->getOriginalName(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			$trace->setActionEntity2(Trace::AE_COMPANY);
			...
			$trace->setMsg(
				$trans->trans('Docgroupcomptable.traceNew',
					array('%docgroupcomptable%' => $entity->getLabel(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			$trace->setActionEntity2(Trace::AE_COMPANY);
			...
			$trace->setMsg(
				$trans->trans('Docgroupbank.traceNew',
					array('%docgroupbank%' => $entity->getLabel(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			$trace->setActionEntity2(Trace::AE_COMPANY);
			...
			$trace->setMsg(
				$trans->trans('Docgroup.traceNew',
					array('%docgroup%' => $entity->getLabel(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			$trace->setActionEntity2(Trace::AE_COMPANY);
			...
			$trace->setMsg(
				$trans->trans('Docgroupfiscal.traceNew',
					array('%docgroupfiscal%' => $entity->getLabel(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			$trace->setActionEntity2(Trace::AE_COMPANY);
			...
			$trace->setMsg(
				$trans->trans('Docgroupperso.traceNew',
					array('%docgroupperso%' => $entity->getLabel(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			$trace->setActionEntity2(Trace::AE_COMPANY);
			...
			$trace->setMsg(
				$trans->trans('Docgroupsyst.traceNew',
					array('%docgroupsyst%' => $entity->getLabel(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			$trace->setActionEntity2(Trace::AE_COMPANY);
			...
			$trace->setMsg(
				$trans->trans('Docgroupaudit.traceNew',
					array('%docgroupaudit%' => $entity->getLabel(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			$trace->setActionEntity2(Trace::AE_COMPANY);
	...
	public function postRemove(LifecycleEventArgs $args)
	{
		...
		if ($entity instanceof User) {
			$trace->setActionEntity(Trace::AE_USER);
			$trace->setMsg($trans->trans('User.traceDel', array('%user%' => $entity->getFullName())));
			$this->persist($trace, $em);
		} elseif ($entity instanceof Job) {
			$trace->setActionEntity(Trace::AE_JOB);
			$trace->setMsg($trans->trans('Job.traceDel', array('%job%' => $entity->getLabel())));
			$this->persist($trace, $em);
		} elseif ($entity instanceof CompanyType) {
			$trace->setActionEntity(Trace::AE_TYPE);
			$trace->setMsg($trans->trans('CompanyType.traceDel', array('%companyType%' => $entity->getLabel())));
			$this->persist($trace, $em);
		} elseif ($entity instanceof Sector) {
			$trace->setActionEntity(Trace::AE_SECTOR);
			$trace->setMsg($trans->trans('Sector.traceDel', array('%sector%' => $entity->getLabel())));
			$this->persist($trace, $em);
		} elseif ($entity instanceof Company) {
			$trace->setActionEntity(Trace::AE_COMPANY);
			...
			$trace->setActionEntity(Trace::AE_FRAME);
			$trace->setMsg(
				$trans->trans('CompanyFrame.traceDel',
					array('%companyFrame%' => $entity->getFullName(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			...
			$trace->setActionEntity(Trace::AE_NATURE);
			$trace->setMsg(
				$trans->trans('CompanyNature.traceDel',
					array('%companyNature%' => $entity->getLabel(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			...
			$trace->setActionEntity(Trace::AE_LABEL);
			$trace->setMsg(
				$trans->trans('CompanyLabel.traceDel',
					array('%companyLabel%' => $entity->getName(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			...
			$trace->setActionEntity(Trace::AE_WHITHHOLDING);
			$trace->setMsg(
				$trans->trans('Withholding.traceDel',
					array('%withholding%' => $entity->getLabel(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			...
			$trace->setActionEntity(Trace::AE_MBPURCHASE);
			$trace->setMsg(
				$trans->trans('MBPurchase.traceDel',
					array('%mbpurchase%' => $entity->getRef(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			...
			$trace->setActionEntity(Trace::AE_SECONDARYVAT);
			$trace->setMsg(
				$trans->trans('SecondaryVat.traceDel',
					array('%secondaryVat%' => $trans->trans('SecondaryVat.vatInfo.' . $entity->getVatInfo()),
						'%sale%' => $entity->getSale()
							->getLabel(), '%mbsale%' => $entity->getSale()
							->getMonthlyBalance()
			...
			$trace->setActionEntity(Trace::AE_SHAREHOLDER);
			$trace->setMsg(
				$trans->trans('Shareholder.traceDel',
					array('%shareholder%' => $entity->getName(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			...
			$trace->setActionEntity(Trace::AE_CUSER);
			$trace->setMsg(
				$trans->trans('CompanyUser.traceDel',
					array('%user%' => $entity->getUser()
						->getFullName(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
			...
			$trace->setActionEntity(Trace::AE_CADMIN);
			$trace->setMsg(
				$trans->trans('CompanyAdmin.traceDel',
					array('%user%' => $entity->getUser()
						->getFullName(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
			...
			$trace->setActionEntity(Trace::AE_DOCGROUPCOMPTABLE);
			$trace->setMsg(
				$trans->trans('Docgroupcomptable.traceDel',
					array('%docgroupcomptable%' => $entity->getLabel(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			...
			$trace->setActionEntity(Trace::AE_DOCGROUPBANK);
			$trace->setMsg(
				$trans->trans('Docgroupbank.traceDel',
					array('%docgroupbank%' => $entity->getLabel(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			...
			$trace->setActionEntity(Trace::AE_DOCGROUPFISCAL);
			$trace->setMsg(
				$trans->trans('Docgroupfiscal.traceDel',
					array('%docgroupfiscal%' => $entity->getLabel(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			...
			$trace->setActionEntity(Trace::AE_DOCGROUPPERSO);
			$trace->setMsg(
				$trans->trans('Docgroupperso.traceDel',
					array('%docgroupperso%' => $entity->getLabel(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			...
			$trace->setActionEntity(Trace::AE_DOCGROUPSYST);
			$trace->setMsg(
				$trans->trans('Docgroupsyst.traceDel',
					array('%docgroupsyst%' => $entity->getLabel(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
			...
			$trace->setActionEntity(Trace::AE_DOCGROUPAUDIT);
			$trace->setMsg(
				$trans->trans('Docgroupaudit.traceDel',
					array('%docgroupaudit%' => $entity->getLabel(), '%company%' => $entity->getCompany()
						->getCorporateName())));
			$trace->setCompanyId($entity->getCompany()
				->getId());
