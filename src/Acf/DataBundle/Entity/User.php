...
class User implements UserInterface, \Serializable
{
	...
	{
		return array('User.lockout.choice.' . self::LOCKOUT_UNLOCKED => self::LOCKOUT_UNLOCKED, 
	...
	{
		return array('User.sexe.choice.' . self::SEXE_MISS => self::SEXE_MISS, 'User.sexe.choice.' . self::SEXE_MRS => self::SEXE_MRS, 
