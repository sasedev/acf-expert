...
abstract class Relation
{
	...
	{
		return array('Relation.physicaltype.choice.' . self::PHTYPE_MORAL => self::PHTYPE_MORAL, 
	...
	{
		return array(self::PHTYPE_MORAL, self::PHTYPE_PHYSIC);
	}

	public function getFullAddress()
	{
		$adr = $this->getStreetNum() . ' ' . $this->getAddress() . ' ' . $this->getAddress2() . ' ' . $this->getTown() . ' ' .
