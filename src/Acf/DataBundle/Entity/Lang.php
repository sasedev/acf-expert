...
class Lang
{
	...
	{
		return array('Lang.status.choice.' . self::ST_DISABLED => self::ST_DISABLED, 
	...
	{
		return array('Lang.direction.choice.' . self::DIR_LTR => self::DIR_LTR, 'Lang.direction.choice.' . self::DIR_RTL => self::DIR_RTL);
	}
	...
	{
		return array(self::DIR_LTR, self::DIR_RTL);
	}
