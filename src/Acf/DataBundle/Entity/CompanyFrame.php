...
class CompanyFrame
{
	...
	{
		return array('CompanyFrame.sexe.choice.' . self::SEXE_MISS => self::SEXE_MISS, 
			'CompanyFrame.sexe.choice.' . self::SEXE_MRS => self::SEXE_MRS, 'CompanyFrame.sexe.choice.' . self::SEXE_MR => self::SEXE_MR);
	}
