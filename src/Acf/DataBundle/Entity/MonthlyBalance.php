...
abstract class MonthlyBalance
{
	...
	{
		return array('MonthlyBalance.month.choice.' . 1 => 1, 'MonthlyBalance.month.choice.' . 2 => 2, 
			'MonthlyBalance.month.choice.' . 3 => 3, 'MonthlyBalance.month.choice.' . 4 => 4, 'MonthlyBalance.month.choice.' . 5 => 5, 
			'MonthlyBalance.month.choice.' . 6 => 6, 'MonthlyBalance.month.choice.' . 7 => 7, 'MonthlyBalance.month.choice.' . 8 => 8, 
			'MonthlyBalance.month.choice.' . 9 => 9, 'MonthlyBalance.month.choice.' . 10 => 10, 'MonthlyBalance.month.choice.' . 11 => 11, 
