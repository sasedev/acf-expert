...
class Docgroupaudit
{
     ...
     * @return Docgroupaudit
     */
    public function setParent(Docgroupaudit $parent = null)
    {
        $this->parent = $parent;
     ...
     * Add child
     *
     * @param Docgroupaudit $child
     *
     * @return Docgroupaudit
     */
    public function addChild(Docgroupaudit $child)
    {
        $this->childs[] = $child;
     ...
     * @return Docgroupaudit
     */
    public function removeChild(Docgroupaudit $child)
    {
