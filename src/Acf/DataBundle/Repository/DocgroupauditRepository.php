 ...
 */
class DocgroupauditRepository extends EntityRepository
{
     ...
     * All count
     *
     * @param Docgroupaudit $dg
     *
     * @return Ambigous <\Doctrine\ORM\mixed, mixed, multitype:,
     *         \Doctrine\DBAL\Driver\Statement, \Doctrine\Common\Cache\mixed>
     */
    public function countAllChilds(Docgroupaudit $dg)
    {
        $c = $dg->getCompany();
        $qb = $this->createQueryBuilder('d')
            ->select('count(d)')
     ...
     * @return \Doctrine\ORM\Query
     */
    public function getAllChildsQuery(Docgroupaudit $dg)
    {
        $c = $dg->getCompany();
        $qb = $this->createQueryBuilder('d')
            ->join('d.company', 'c')
     ...
     *         \Doctrine\Common\Cache\mixed>
     */
    public function getAllChilds(Docgroupaudit $dg)
    {
