 ...
 */
class DocgroupcomptableRepository extends EntityRepository
{
     ...
     * All count
     *
     * @param Docgroupcomptable $dg
     *
     * @return Ambigous <\Doctrine\ORM\mixed, mixed, multitype:,
     *         \Doctrine\DBAL\Driver\Statement, \Doctrine\Common\Cache\mixed>
     */
    public function countAllChilds(Docgroupcomptable $dg)
    {
        $c = $dg->getCompany();
        $qb = $this->createQueryBuilder('d')
            ->select('count(d)')
     ...
     * @return \Doctrine\ORM\Query
     */
    public function getAllChildsQuery(Docgroupcomptable $dg)
    {
        $c = $dg->getCompany();
        $qb = $this->createQueryBuilder('d')
            ->join('d.company', 'c')
     ...
     *         \Doctrine\Common\Cache\mixed>
     */
    public function getAllChilds(Docgroupcomptable $dg)
    {
