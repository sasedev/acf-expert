 ...
 */
class DocgroupbankRepository extends EntityRepository
{
     ...
     * All count
     *
     * @param Docgroupbank $dg
     *
     * @return mixed|\Doctrine\DBAL\Driver\Statement|array|NULL
     */
    public function countAllChilds(Docgroupbank $dg)
    {
        $c = $dg->getCompany();
     ...
     * @return \Doctrine\ORM\Query
     */
    public function getAllChildsQuery(Docgroupbank $dg)
    {
        $c = $dg->getCompany();
     ...
     * @return mixed|\Doctrine\DBAL\Driver\Statement|array|NULL
     */
    public function getAllChilds(Docgroupbank $dg)
    {
