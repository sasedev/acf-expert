...
class NewTForm extends AbstractType
{
	...
	public function buildForm(FormBuilderInterface $builder, array $options)
	{
		...
		$builder->add('entreprise', TextType::class,
			array(
		...
		$builder->add('entrepriseForm', TextType::class,
			array(
		...
		$builder->add('activity', TextType::class,
			array(
		...
		$builder->add('dtActivation', DateType::class,
			array(
				...
				'required' => false,
				'constraints' => array(
					new GreaterThanOrEqual(array("value"=>"1950-01-01")),
					new LessThan((array("value"=>"2100-01-01")))
				)
			));
		...
		$builder->add('caYear', NumberType::class,
			array(
		...
		$builder->add('nbrInvoicesBuy', IntegerType::class,
			array(
		...
		$builder->add('nbrInvoicesSale', IntegerType::class,
			array(
		...
		$builder->add('nbrSalaries', IntegerType::class,
			array(
		...
		$builder->add('hasexpert', ChoiceType::class,
			array(
		...
		$builder->add('otherInfos', TextareaType::class,
			array(
